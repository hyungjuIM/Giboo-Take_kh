                    ...
                    <div class="user_sec">
                        <div class="myPage">
                            ...
                            <section class="laginArea">
                               ...
                               <%--  <%-- 로그인 된 후 --%>
                                    <c:otherwise>
                                        <div class="nick_container"><span id="nickName">
                                            ${loginMember.userNick}</span>님
                                        </div>
                                    </c:otherwise>
                                     --%>
                            </section>

                            <div class="toggle"><a href="${pageContext.request.contextPath}/mypage/mypageMain"
                                    class="tooltip" data-text="마이페이지">
