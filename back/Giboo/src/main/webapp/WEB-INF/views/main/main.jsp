	...
	<main>
		...
		<div class="container">
			...
			<section class="contentCount">
				<div class="inner title_style">
					...
					<div class="count_box1">
						<img
							src="${pageContext.request.contextPath}/resources/images/main_img/bunny_01.png">
						<div class="count_box1_container">
							<h3>
								이웃을 향한 아름다운 도움의 손길을<br> 실천하는 Hunny :)
							</h3>
							<p>
								봉사 1회에 행복지수 10%가 상승하는 사실 알고 계셨나요?<br>Hunny와 함께 나와 우리 이웃의
								행복지수를 높여보아요!
							</p>
						</div>
					</div>
					<div class="count_box2">
						<div class="vol_count_person">
							...
							<p>
								2023년 Hunny를 통해 이웃들을 위한<br>봉사활동에 참여한 봉사자들 입니다.
							</p>
						</div>
						<div class="vol_count_money">
							<h3>
								<span>5,248,002</span>원
							</h3>
							<p>
								2023년 Hunny에 진행된 기부 활동에<br>모여진 기부금액 입니다.
							</p>
						</div>
					</div>
				</div>
			...
			<section class="volContainer">
				...
				<div class="vol_box_container">
					...
					<ul class="allSlides slidesStyle">
						<li class="vol_box_style vol_box">
							...
							<div>
								<img
									src="${pageContext.request.contextPath}/resources/images/childimg.jpeg">
							</div>

							<div class="vol_content_part">
								<div class="vol_content_per_container">
									<span class="vol_con_bar"> <span class="vol_con_bar_per"></span>
									</span> <span class="tooltip"><span>14</span>/20</span>
								</div>

								<div class="vol_content">
									<h3>아동 놀이 치료 봉사자 및 보조 봉사자를 모집합니다.</h3>
									<div>
										<span>모집</span><span>2023. 06. 12 ~ 2023. 06. 17</span>
									</div>
								</div>
								<div class="vol_tag">
									<div>
										<span class="vol_tag_child">어린이</span> <span
											class="vol_tag_applyPlay">놀이지원</span>
									</div>
									<div class="vol_like">
				...
				<div class="vol_next_prev_btn">
					<span class="vol_prev">prev</span> <span class="vol_next">next</span>
				</div>
			...
			<section class="donationContainer">
							...
							<li class="swiper-slide do_box">
								...
								<div class="do_right">
									...
									<div class="doTitle">
										...
										<div>
											모집 <span>2023. 06. 12 ~ 2023. 06. 17</span>
										</div>
									</div>

									<div class="do_content_per">
										<span class="do_con_bar"> <span class="do_con_bar_per"></span>
										</span> <span class="doTooltip"><span>14</span>/20 </span>
									</div>
				...
				<div class="do_next_prev_btn">
					<span class="swiper-button-prev do_prev">prev</span> <span
						class="swiper-button-next do_next">next</span>
				</div>
			...
			<section class="userReview">
				...
				<div class="re_box_container">
					...
					<div class="re_box">
						...
						<div class="re_char">
							<img
								src="${pageContext.request.contextPath}/resources/images/main_img/re_img.png"
								alt="">
						</div>
						...
						<div class="tag_box_context">
							...
							<span>5.0</span> <span>매우 만족해요!</span>
						</div>

						<div class="re_content_container">
							<span>완전 추천합니다!</span> <span class="re_content"> 갈 때 마다
								어르신들이 너무 반겨 주셔서 제가 힐링받고 오는 곳입니다. 정말 어르신들 너무 좋으시고 추천합니다! </span>
							<div>
								<span class="re_user_name">유정</span> <span>2023. 04. 01
									방문 · 재방문 2회</span>
							</div>
						</div>
						<div class="re_active_info">
							<span>활동</span> <span>요양원 입소 어르신 나들이 활동 이동 보조 및 말벗 지원</span>
						</div>
