        ...
        <div class="edCategory">
            <div class="edCategoryWidth">
                    <div class="edEventintro">
                        <a href="../event/eventDetailMain/${eventList.eventNo}?cp=${pagination.currentPage}${sURL}">
                            <span>이벤트 소개</span>
                        </a>
                    </div>
                    <div class="edEventintro">
                    ...
                    <div class="edEventintro">
                        <a href="../event/eventDetailBoardPhoto/${eventList.eventNo}?cp=${pagination.currentPage}${sURL}">
                            <span>참여보드</span>
                        </a>
                    </div>
            </div>
