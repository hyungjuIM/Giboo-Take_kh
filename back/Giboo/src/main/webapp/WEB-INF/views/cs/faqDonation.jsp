<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <c:set var="faqDonation" value="${map.faqDonation}" />
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>faqDonation page</title>
                ...
                <section class="cs-faqContainer">
                    <div class="faqContent">
                        ...
                        <div id="Accordion_wrap">
                                <c:choose>
                                    <c:when test="${empty faqDonation}">
                                        <span>자주찾는질문이 존재하지 않습니다.</span>
                                    </c:when>
                                    <c:otherwise>
                                        <c:forEach var="faqDonation" items="${faqDonation}">
                                            <div class="que">
                                                <div class="queCategory">
                                                    <span>${faqDonation.faqCategory}</span>
                                                </div>
                                                <span>${faqDonation.faqTitle}</span>
                                            ...
                                            <div class="anw">
                                                <div class="anw2">
                                                    <span id="anw-content">${faqDonation.faqContent}</span>
                                                    <div class="dontAnw">
