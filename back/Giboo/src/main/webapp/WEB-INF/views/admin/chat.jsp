...
<body>
    ...
    <section class="mainContainer">
        <div class="menuName">1 대 1 채팅 상담</div>
                    ...
                    <table class="listTable">
                        <tbody>
                            <tr class="sortingOptionArea">
                                ...
                                <td><button id="sortByChatStatus">상담 여부</button></td>
                            </tr>
                            ...
                            <tr class="listArea">
                                ...
                                <td><button id="openChat1" class="openChat">상담하기</button></td>
                            </tr>
                            ...
                            <tr class="listArea">
                                ...
                                <td>2023. 01. 01</td>
                                <td class="waiting">대기중</td>
                                <td><button id="openChat2" class="openChat">상담하기</button></td>
                            </tr>
