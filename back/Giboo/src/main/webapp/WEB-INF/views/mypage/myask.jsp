...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mypage/myask.css">
<link rel="stylesheet"
									...
									<div class="myask_container1">
										...
										<div class="myask_container2">
											<div class="myask_search-area">
												...
												<form action="">
													<fieldset>
														<input type="text" id="myask_query" name="myask_query"
										...
										<table class="myask_notice-table">
											...
											<tbody>
												...
												<tr>
													<td>5</td>
													<td>기부>어린이</td>
													<td><a href="#!">어린이 기부를 할 때 소아암 환우에게 하고 싶은데 방법이
															있나요?</a></td>
													<td>2023.05.05</td>
													<td>답변완료</td>
												</tr>
